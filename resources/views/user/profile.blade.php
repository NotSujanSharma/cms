    ...
    <div class="flex-1 p-8 overflow-auto">
        ...
        <div class="mb-8">
            ...
            <a href="{{route('user.edit')}}"
                class="bg-blue-100 py-3 mx-3 p-3 rounded-lg hover:bg-blue-300 transition duration-300">
                Edit Profile
            </a>
                    ...
                    @foreach($user->events as $event)
                        <div class="bg-blue-100 p-4 rounded-xl border flex flex-col gap-2 shadow-md">
                            ...
                            <form action="{{ route('event.leave', $event->id) }}" method="POST">
                                @csrf
                                <button class="bg-red-300 px-4 py-2 rounded-full text-sm">Request to Leave</button>
                            </form>
                        </div>
                    @endforeach
                </div>
